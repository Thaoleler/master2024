...
$("input#formViewNodeDeviceVerticalSpace").val(document.Graph.settings.deviceVerticalSpace);
...
$("input#formViewNodeDeviceVerticalSpace").change(function() {
    document.Graph.settings.deviceVerticalSpace = parseInt($("input#formViewNodeDeviceVerticalSpace").val());
    refreshGraph();
})
...
$("button#formViewResetButton").click(function() {
    ...
    document.Graph.settings.deviceVerticalSpace = 50;
